...
// ==============================================================
#ifndef __net_fmul_32ns_32ncud__HH__
#define __net_fmul_32ns_32ncud__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(net_fmul_32ns_32ncud) {
    ...
    SC_CTOR(net_fmul_32ns_32ncud):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
